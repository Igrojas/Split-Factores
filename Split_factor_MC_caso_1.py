...
for i in range(iter_mc):
    ...
    fila = {
        ...
        'sp_Jameson_2_masa': sp_jms_2[0],
        'sp_Jameson_2_cuf': sp_jms_2[1],
        ...
        'er_jameson_2': sp_jms_2[1]/sp_jms_2[0],
...
df_resultados.to_excel(os.path.join('results', 'results_caso_1.xlsx'), index=False)
...
def graficar_resultados(df, rec_min=None, rec_max=None, ley_min=None, ley_max=None):
    ...
    df_filtrado = df_filtrado[df_filtrado['er_jameson_2'] <= 8]
